...
namespace PangeaCyber.Net.Store.Tests
{
    public class ITStoreTest
    {
        private const string TESTFILE_PATH = "./data/testfile.pdf";
        private StoreClient client;
        private readonly TestEnvironment environment = TestEnvironment.DEV;
        ...
        public ITStoreTest()
        {
            ...
            client = new StoreClient.Builder(config).Build();
        ...
        public async Task TestFileScanSplitUploadPost()
        {
            ...
            StoreFileUploader fileUploader = new StoreFileUploader.Builder().Build();
