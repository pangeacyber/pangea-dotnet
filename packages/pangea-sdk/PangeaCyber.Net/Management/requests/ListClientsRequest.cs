...
public class ListClientsRequest : BaseRequest
{
    /// <summary>
    ...
    public IList<string>? ClientIdContains { get; set; }

    /// <summary>
    /// Only records where id equals one of the provided substrings
    /// </summary>
    [JsonProperty("client_id__in")]
    public IList<string>? ClientIdIn { get; set; }
