...
namespace PangeaCyber.Net.AuthN.Clients
{
    ...
    public class ClientSession : AuthNBaseClient
    {
        ...
        public async Task<Response<ClientSessionInvalidateResult>> Invalidate(string token, string sessionID)
        {
            ...
            return await DoPost<ClientSessionInvalidateResult>("/v1/client/session/invalidate", request);
        }
        ...
        {
            return await DoPost<ClientSessionListResult>("/v1/client/session/list", request);
        }
        ...
        public async Task<Response<ClientSessionLogoutResult>> Logout(string token)
        {
            ...
            return await DoPost<ClientSessionLogoutResult>("/v1/client/session/logout", request);
        }
        ...
        {
            return await DoPost<ClientSessionRefreshResult>("/v1/client/session/refresh", request);
        }
